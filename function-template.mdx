...
<Note>
Optional note, includes limitations on this function.<br/><br/>Another paragraph.
</Note>
...
For a full list of parameter labels for different types of inputs, see other documented functions.
