...
* [History-based query optimization](/overview/queries/understand-query-performance-hbs), which leverages past query patterns to improve query plans for new queries.
