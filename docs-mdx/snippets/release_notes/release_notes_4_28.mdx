...
Added an additional [hint comment](/performance-and-observability/query-planning/query-hints) that can indicate [unique columns](/performance-and-observability/query-planning/query-hints/unique-constraint).
