...
Documentation for the setting is available [here](/reference/system-settings#changing-the-optimizer-mode).
...
Documentation for the setting is available [here](/reference/system-settings#using-storage-manager-statistics-in-the-optimizer).
