...
We expect this to provide a general performance improvement. Users can [temporarily opt out by changing their CO engine to use an AMD-specific engine type](/guides/operate-engines/arm-co-opt-out).
