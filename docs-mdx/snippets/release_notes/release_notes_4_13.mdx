...
Users can now only access information about objects for which they have the appropriate permissions or ownership for in [information_schema views](/reference-sql/information-schema/views).
