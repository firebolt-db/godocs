...
The Firebolt **Develop Space** user interface added the following Windows/Mac [keyboard shortcuts](/guides/run-queries/using-the-develop-workspace#keyboard-shortcuts-for-the-develop-space):
