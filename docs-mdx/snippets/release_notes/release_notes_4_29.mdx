...
For more information refer to the [ALTER ENGINE](/reference-sql/commands/engines/alter-engine) and [information_schema.engines](/reference-sql/information-schema/engines) reference pages
