---
sidebarTitle: Deployment and Operational Guide
...
As outlined above, [Docker storage mounts](https://docs.docker.com/engine/storage/) can be used to inject a configuration file into the Firebolt Core Docker containers, and to control where any persistent or temporary data is written by Firebolt Core. Some concrete examples of this are provided in the [Docker Compose](/firebolt-core/firebolt-core-deployment-compose) and [Kubernetes](/firebolt-core/firebolt-core-deployment-k8s) deployment guides; this section provides some general guidelines for such storage mounts.
...
When deploying using [Docker compose](/firebolt-core/firebolt-core-deployment-compose) or [Kubernetes](/firebolt-core/firebolt-core-deployment-k8s), most of these considerations are already taken care of and you can focus on customising only specific aspects like resource allocation and topology.
