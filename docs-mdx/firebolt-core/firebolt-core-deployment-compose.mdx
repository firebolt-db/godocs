...
This is useful if you have multiple hosts that are already on the same network (for example, your home or office LAN); if you have remote machines available on Kubernetes, see [Deploy using Kubernetes](/firebolt-core/firebolt-core-deployment-k8s) instead.
...
Continue reading: [Deploy using Kubernetes](/firebolt-core/firebolt-core-deployment-k8s)
