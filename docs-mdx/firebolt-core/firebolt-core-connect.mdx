...
* The [Firebolt Go SDK](https://github.com/firebolt-db/firebolt-go-sdk) from version 1.14.1. See [Connect with JDBC](/firebolt-core/firebolt-core-connect/firebolt-core-connect-go) for details.
