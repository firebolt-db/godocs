...
If necessary, [system settings](/reference-sql/system-settings) can be adjusted for individual queries by appending them as parameters to the HTTP query string. For example, the `timezone` setting can be adjusted as follows.
...
Firebolt offers a number of [client SDKs](/guides/developing-with-firebolt) for its managed cloud data warehouse. Not all of our SDKs can be used to connect to Firebolt Core yet. We will gradually extend SDK coverage as Firebolt Core moves beyond public preview (see also [Roadmap](/firebolt-core/firebolt-core-roadmap)). The following client SDKs are currently supported.

* The [Firebolt Go SDK](https://github.com/firebolt-db/firebolt-go-sdk) from version 1.14.1. See [Connect with Go](/firebolt-core/firebolt-core-connect/firebolt-core-connect-go) for details.
...
* The [Firebolt Node.js SDK](https://github.com/firebolt-db/firebolt-node-sdk) from version 1.15.0. See [Connect with Node.js](/firebolt-core/firebolt-core-connect/firebolt-core-connect-nodejs) for details.
* The [Firebolt Python SDK](https://github.com/firebolt-db/firebolt-python-sdk/) from version 1.13.0. See [Connect with Python](/firebolt-core/firebolt-core-connect/firebolt-core-connect-python) for details.
