...
* The [Firebolt JDBC driver](https://github.com/firebolt-db/jdbc) from version 3.6.3. See [Connect with JDBC](/firebolt-core/firebolt-core-connect-jdbc) for details.
