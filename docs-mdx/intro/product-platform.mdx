...
## <img src="/assets/images/icon-data_management.png" alt="Icon for data management." style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "40px"}}/> Data management
...
## <img src="/assets/images/icon-processing.png" alt="Icon for query processing." style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "40px"}}/> Query processing
...
For more information, see the [Firebolt API](/guides/developing-with-firebolt/using-the-api), and the Firebolt [functions glossary](/reference-sql/functions-reference/functions-glossary).

## <img src="/assets/images/icon-security.png" alt="Icon for security." style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "40px"}}/> Security
...
## <img src="/assets/images/icon-observability.png" alt="Icon for observability." style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "40px"}}/> Observability
...
## <img src="/assets/images/icon-collaboration.png" alt="Icon for collaboration." style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "40px"}}/> Collaborative workspace
