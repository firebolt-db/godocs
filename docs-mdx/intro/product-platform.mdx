...
For more information, see the [Firebolt API](/guides/run-queries/using-the-api), and the Firebolt [functions glossary](/reference-sql/functions-reference/functions-glossary).
