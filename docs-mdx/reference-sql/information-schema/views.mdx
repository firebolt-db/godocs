...
To access information about views, you must have `USAGE` privileges on both the [schema](/overview/security/rbac/database-permissions/schema-permissions#schema-level-privileges) and the [database](/overview/security/rbac/database-permissions/schema-permissions#schema-level-privileges). You also need ownership of the view or [view-level privileges](/overview/security/rbac/database-permissions/view-permissions#view-permissions). 
