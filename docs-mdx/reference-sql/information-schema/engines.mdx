...
| cache_size        | TEXT        | Maximum memory ratio used for different cache pools (in percent relative to the total available memory). This indicates how much of the engine's memory is used for each type of cache (e.g., [result cache](/overview/queries/understand-query-performance-subresult)).                                                                                                                                                        |
