...
In order to view catalog information, you must have [catalog](/overview/security/rbac/database-permissions#database-level-privileges) privileges or have ownership of the catalog object.
