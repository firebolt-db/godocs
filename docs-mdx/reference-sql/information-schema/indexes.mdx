---
description:
  Use this reference to learn about the metadata available for Firebolt
...
| index_owner        | TEXT        | The owner of the index.                                                                                |
| index_origin       | TEXT        | Index creation origin: 'USER' or 'SYSTEM' or NULL if not applicable                                    |
