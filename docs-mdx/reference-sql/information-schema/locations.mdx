...
To view location information, you must have `LIST LOCATION` or `LIST ANY LOCATION` privileges. For more information about location permissions, see [CREATE LOCATION](/reference-sql/commands/data-definition/create-location).
