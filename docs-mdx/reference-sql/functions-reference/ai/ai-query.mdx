...
<Note>
Your account must explicitly allow Amazon Bedrock. An administrator needs to enable `ALLOW_AMAZON_BEDROCK`. See [ALTER ACCOUNT SET ALLOW_AMAZON_BEDROCK](/reference-sql/commands/data-definition/alter-account/#alter-account-set-allow-amazon-bedrock).
</Note>
