...
Use this when analyzing a sample rather than an entire population. For covariance of population see [COVAR_POP](/reference-sql/functions-reference/aggregation/covar-pop).
