...
[APACHE_DATASKETCHES_HLL_BUILD](/reference-sql/functions-reference/datasketches/apache-datasketches-hll-build), [APACHE_DATASKETCHES_HLL_MERGE](/reference-sql/functions-reference/datasketches/apache-datasketches-hll-merge), [APACHE_DATASKETCHES_HLL_ESTIMATE](/reference-sql/functions-reference/datasketches/apache-datasketches-hll-estimate).
