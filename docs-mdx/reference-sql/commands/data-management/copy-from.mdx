...
| Parameter             | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|:----------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `SUPPORT_STRUCTS`     |  A boolean which specifies whether structs in the source data are to be inferred as STRUCT data types. The default value is `FALSE`. For more information, see [Load Parquet structs](/reference-sql/commands/data-management/copy-from#load-parquet-structs). |
...
- `cross_region_request_mode` to [access data](/reference/system-settings#access-cross-region-data) in cross-region Amazon S3 buckets.
