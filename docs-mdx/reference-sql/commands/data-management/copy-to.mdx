...
<option>:
    ...
    [ MAX_FILE_SIZE = <bytes> ]
    [ OVERWRITE_EXISTING_FILES = TRUE | FALSE ]
    [ HEADER = TRUE | FALSE ]
    [ <settings> ]
...
| `<location_name>`                    | The name of a location object that contains the Amazon S3 URL and credentials. This is the recommended approach for specifying the destination. See [CREATE LOCATION](/reference-sql/commands/data-definition/create-location) for more information.                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
For a comprehensive guide to LOCATION objects, see [LOCATION objects](/guides/security/location). For complete syntax reference, see [CREATE LOCATION](/reference-sql/commands/data-definition/create-location).
