...
For more information regarding catalogs, see [information_schema.catalogs](/reference-sql/information-schema/catalogs).
...
| :----------- | :------------ | :---------------------------- | :---------------------------- | :-------------- | :---------------------------------------------------------------- | :------------ |
| AdTechDB_v4  | firebolt-demo | 2024-09-03 11:48:31.683328+00 | 2024-09-03 11:48:31.683328+00 | firebolt-demo   | CREATE DATABASE AdTechDB_v4 () WITH DESCRIPTION=\'DB for AdTech\' | DB for AdTech |
