...
```
[0] [Projection] lineitem.l_shipdate, lineitem.l_linestatus, lineitem.l_orderkey, avg2_1
|   [Execution Metrics]: Optimized out
 \_[1] [SortMerge] OrderBy: [lineitem.l_shipdate Ascending Last, lineitem.l_linestatus Ascending Last, lineitem.l_orderkey Ascending Last, avg2_1 Ascending Last]
   |   [Execution Metrics]: output cardinality = 175272184, thread time = 15776ms, cpu time = 15773ms
    \_[2] [Shuffle] Gather
      |   [Affinity]: many nodes
      |   [Execution Metrics]: output cardinality = 175272184, thread time = 1344ms, cpu time = 1339ms
       \_[3] [Sort] OrderBy: [lineitem.l_shipdate Ascending Last, lineitem.l_linestatus Ascending Last, lineitem.l_orderkey Ascending Last, avg2_1 Ascending Last]
         |   [Execution Metrics]: output cardinality = 175272184, thread time = 161940ms, cpu time = 161370ms
          \_[4] [AggregateMerge] GroupBy: [lineitem.l_orderkey, lineitem.l_linestatus, lineitem.l_shipdate] Aggregates: [avg2_1: avg2merge(avg2_0)]
            |   [Types]: avg2_1: numeric(38, 9) null
            |   [Execution Metrics]: output cardinality = 175272184, thread time = 102041ms, cpu time = 95573ms
             \_[5] [Shuffle] Hash by [lineitem.l_orderkey, lineitem.l_linestatus, lineitem.l_shipdate]
               |   [Affinity]: many nodes
               |   [Execution Metrics]: output cardinality = 175272516, thread time = 21998ms, cpu time = 20321ms
                \_[6] [AggregateState partial] GroupBy: [lineitem.l_orderkey, lineitem.l_linestatus, lineitem.l_shipdate] Aggregates: [avg2_0: avg2(lineitem.l_discount)]
                  |   [Types]: avg2_0: aggregatefunction(avg2ornull, numeric(38, 9) null) not null
                  |   [Execution Metrics]: output cardinality = 175272516, thread time = 153805ms, cpu time = 151232ms
                   \_[7] [Projection] lineitem.l_orderkey, lineitem.l_discount, lineitem.l_linestatus, lineitem.l_shipdate
                     |   [Execution Metrics]: Optimized out
                      \_[8] [Filter] (lineitem.l_returnflag = 'N'), (lineitem.l_shipdate > DATE '1996-01-01')
                        |   [Execution Metrics]: output cardinality = 178187768, thread time = 4065ms, cpu time = 4048ms
                         \_[9] [TableFuncScan] lineitem.l_orderkey: $0.l_orderkey, lineitem.l_discount: $0.l_discount, lineitem.l_returnflag: $0.l_returnflag, lineitem.l_linestatus: $0.l_linestatus, lineitem.l_shipdate: $0.l_shipdate
                           |   $0 = read_tablets(table_name => lineitem, tablet)
                           |   [Types]: lineitem.l_orderkey: bigint null, lineitem.l_discount: numeric(38, 9) null, lineitem.l_returnflag: text null, lineitem.l_linestatus: text null, lineitem.l_shipdate: date null
                           |   [Execution Metrics]: output cardinality = 216026836, thread time = 24315ms, cpu time = 24237ms, granules: 52257/52257
                            \_[10] [Projection] tablet
                              |   [Execution Metrics]: Optimized out
                               \_[11] [Filter] (((min_l_returnflag > 'N') or (max_l_returnflag < 'N')) IS DISTINCT FROM TRUE), ((max_l_shipdate <= DATE '1996-01-01') IS DISTINCT FROM TRUE)
                                 |   [Execution Metrics]: output cardinality = 14, thread time = 1ms, cpu time = 1ms
                                  \_[12] [TableFuncScan] tablet: $0.tablet, min_l_returnflag: $0.min_l_returnflag, max_l_returnflag: $0.max_l_returnflag, max_l_shipdate: $0.max_l_shipdate
                                    ...
                                    |   [Execution Metrics]: output cardinality = 14, thread time = 1ms, cpu time = 0ms
                                     \_[13] [Projection]
...
For `TableFuncScan` operators that read from tables with primary indexes, additional metrics may be displayed:
- `granules` shows the output granules (not pruned) out of the total number of granules that were considered.


These metrics help you understand the effectiveness of primary index pruning in reducing the amount of data scanned during query execution. In the example above, `granules: 52257/52257` indicates that no granules were pruned by the primary index, meaning all 52,257 granules were scanned.
