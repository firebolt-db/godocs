...
This document captures specific and examples for location objects for Iceberg. For more on location objects in general, see [CREATE LOCATION](/reference-sql/commands/data-definition/create-location).
