...
This document captures specifics and examples for location objects for Amazon S3. For more on location objects in general, see [CREATE LOCATION](/reference-sql/commands/data-definition/create-location).
