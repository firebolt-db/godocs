...
||||||| parent of 219f0125 (fix: add 4.23 release notes to archive - complete both fixes (FIR-47451))
*  Update error message to explain upper case behavior
=======
*  Update error message to explain upper case behavior   
>>>>>>> 219f0125 (fix: add 4.23 release notes to archive - complete both fixes (FIR-47451))  
