...
- [derive_ndv_from_unique_keys](#derive-ndv-from-unique-keys)
...
- [as_hbs_training_data](#marking-queries-as-hbs-training-data)
- [hbs_object_id](#using-an-hbs-snapshot-for-query-planning)
...
```text Plan with derive_ndv_from_unique_keys = true {4,10}
...
```text Plan with derive_ndv_from_unique_keys = false {4,10}
[0] [Projection] orders.id, orders.price, orders.city, accounts.id, orders.city
