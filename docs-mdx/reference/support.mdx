---
description: Describes the options of the Firebolt Support menu
...
### Release Notes
The Release Notes link brings you to Firebolt's [latest version release notes](/reference/release-notes).
...
All support team activity is logged and can be viewed in the [query history](/reference-sql/information-schema/engine-query-history).
