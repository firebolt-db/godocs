...
### Approximate engine node specifications
...
**TIP:** You can use [Multi-Cluster Engine Warmup](/reference-sql/system-settings#multi-cluster-engine-warmup) to submit your checksum queries to all clusters in a multi-cluster engine. 
