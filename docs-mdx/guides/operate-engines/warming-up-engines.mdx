...
A query submitted to a multi-cluster engine is only sent to one cluster. If you want to explicitly warm up a multi-cluster engine you should use the [Multi-Cluster Engine Warmup](/reference/system-settings#multi-cluster-engine-warmup) setting to send that query to all clusters of the engine.
