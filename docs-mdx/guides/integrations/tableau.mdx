...
4. **Start Tableau and verify Firebolt connector availability**
    ...
    1. Start your Tableau Desktop or Server. If you selected "Install and restart Tableau" in the previous step it should restart automatically.
    2. In the left navigation panel, under **To a Server**, you should see "Firebolt Connector by Firebolt".
