...
## Connect to Tableau Desktop or Tableau Prep
To connect to Tableau Desktop or Tableau Prep, you must download a Firebolt connector, a [JDBC driver](/guides/developing-with-firebolt/connecting-with-jdbc#jdbc-driver), connect to Firebolt, and select a database and schema to query.
...
4. **Start Tableau and verify Firebolt connector availability**
    ...
    3. Select it and Enter the following parameters in the **General** tab:
