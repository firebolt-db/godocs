...
<img src="/assets/images/paradime_logo.png" alt="Paradime logo" style={{"width": "400px"}}/>
...
1. **Firebolt Account**: Ensure that you have access to an active Firebolt account. If you don't have access, you can [sign up for an account](https://go.firebolt.io/signup). For more information about how to register with Firebolt, see [Get started with Firebolt](/guides/getting-started).
