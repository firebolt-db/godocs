...
1. On the [Firebolt Workspace page](https://go.firebolt.io/), select the **Configure**(<img src="/assets/images/configure-icon.png" alt="AggIndex" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "20px"}}/>) icon from the left navigation pane.
