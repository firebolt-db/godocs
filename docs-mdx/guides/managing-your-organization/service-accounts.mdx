...
*  The [Firebolt API](/guides/run-queries/using-the-api) - directly interacts with Firebolt’s data warehouse using HTTP requests.
...
<img src="/assets/images/service_accounts_create.png" alt="The first step to obtain programmatic access is to create a service account." style={{"width": "500px"}}/>
...
1. Select the **Configure** icon (<img src="/assets/images/configure-icon.png" alt="The icon to open the Configure Space." style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "20px"}}/>) in the left navigation pane to open the **Configure Space**.
...
<img src="/assets/images/service_accounts_id.png" alt="The second step to obtain programmatic access is to get a service account ID." style={{"width": "500px"}}/>
...
<img src="/assets/images/service_accounts_secret.png" alt="The third step to obtain programmatic access is to generate a secret." style={{"width": "500px"}}/>
...
<img src="/assets/images/service_accounts_user.png" alt="The last step to obtain programmatic access is to create a user." style={{"width": "500px"}}/>
...
1. Select the Govern icon (<img src="/assets/images/govern-icon.png" alt="The icon to open the Govern Space." style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "20px"}}/>) in the left navigation pane to open the **Govern Space**.
...
```bash
curl -X POST --location 'https://idp.app.firebolt.io/oauth/token' \
...
1. Select **Configure** icon (<img src="/assets/images/configure-icon.png" alt="The icon to open the Configure Space." style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "20px"}}/>) in the left navigation pane to open the **Configure Space**.
