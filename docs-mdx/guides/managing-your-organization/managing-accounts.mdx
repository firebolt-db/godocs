...
To view all accounts, click **Configure** to open the configure space, then choose **Accounts** from the menu, or query the [information_schema.accounts](/reference-sql/information-schema/accounts) view. 
