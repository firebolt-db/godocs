...
The Firebolt Go SDK can be used to connect to Firebolt Core. The connection process is the same, but the DSN parameters differ. For more information on connecting to Firebolt Core, refer to the [Firebolt Core Go SDK documentation](/firebolt-core/firebolt-core-connect/firebolt-core-connect-go).
