...
4. After you submit the AWS PrivateLink request, Firebolt's support team will review it, provision a dedicated VPC endpoint service in your account's AWS region, and send an email to the requestor containing the `endpointServiceId`. Save this information for configuration.
