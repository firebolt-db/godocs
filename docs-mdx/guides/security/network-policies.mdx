...
To view all network policies, click **Configure** to open the configure space, then choose **Network policies** from the menu, or query the [information_schema.network_policies](/reference-sql/information-schema/network_policies) view. 
...
<img src="/assets/images/editnetworkpolicy.png" alt="Edit network policy" style={{"width": "500px"}}/>
...
<img src="/assets/images/deletenetworkpolicy.png" alt="Delete network policy" style={{"width": "500px"}}/>
