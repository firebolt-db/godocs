...
1. Login to the [Firebolt Workspace](https://firebolt.go.firebolt.io/signup).
2. Select the **Configure** icon (<img src="/assets/images/configure-icon.png" alt="The Firebolt Configure Space icon." width="20" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0"}}/>)from the left navigation bar to open the **Configure Space**.
...
1. Select the **Configure** icon (<img src="/assets/images/configure-icon.png" alt="The Firebolt Configure Space icon." width="20" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0"}}/>) from the left navigation bar to open the **Configure Space**.
