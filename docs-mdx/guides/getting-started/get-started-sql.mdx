...
For more information about Firebolt’s **Develop Space**, see [Using the develop workspace](/guides/run-queries/using-the-develop-workspace).
...
For more information about Firebolt’s **Develop Space**, see [Use the Develop Space](/guides/run-queries/using-the-develop-workspace).
