...
* **Database selection**(<img src="/assets/images/develop-space-database.png" alt="develop space select database image" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "20px"}}/>): Choose the database for your SQL statements.
* **Engine selection**(<img src="/assets/images/develop-space-select-engine.png" alt="develop space select engine image" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "25px"}}/>): Choose the running engine or select to start an engine for running queries.
...
Switch themes by selecting the toggle (<img src="/assets/images/dark-mode-toggle.png" alt="toggle button for dark and light mode" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "15px"}}/>) at the bottom-left corner of the workspace.

## Resource center
The Resource Center provides quick access to essential Firebolt resources. Select the **Firebolt icon**(<img src="/assets/images/firebolt-icon-transparent.png" alt="Firebolt icon transparent" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0", "width": "22px"}}/>) in the bottom-right corner of the Results panel to open the Resource Center, which includes:
