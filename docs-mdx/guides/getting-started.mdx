...
After you register, you can either use the [Load data wizard](/guides/getting-started/get-started-load-data-wizard) or the [use SQL](/guides/getting-started/get-started-sql). Use the Load data wizard if your data is in either CSV or Parquet format, and you want to use a graphical user interface to guide you through the first three steps of the workflow. Use the Firebolt **Develop Space** or an API if you prefer to enter SQL, or need a more customized workflow.

## Next steps

Choose either of the following:

* [Get started using a wizard](/guides/getting-started/get-started-load-data-wizard)
* [Get started using SQL](/guides/getting-started/get-started-sql)
