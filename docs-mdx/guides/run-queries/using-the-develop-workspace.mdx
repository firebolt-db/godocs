...
* **Database selection**(<img src="/assets/images/develop-space-database.png" alt="develop space select database image" width="20" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0"}}/>): Choose the database for your SQL statements.
* **Engine selection**(<img src="/assets/images/develop-space-select-engine.png" alt="develop space select engine image" width="25" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0"}}/>): Choose the running engine or select to start an engine for running queries.
...
Switch themes by selecting the toggle (<img src="/assets/images/dark-mode-toggle.png" alt="toggle button for dark and light mode" width="15" style={{"display": "inline", "margin-bottom": "0", "margin-top": "0"}}/>) at the bottom-left corner of the workspace.
