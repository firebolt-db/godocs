...
* The [Firebolt API](/guides/query-data/using-the-api) &ndash; A REST API that provides access to Firebolt databases. Allows you to create a custom integration with Firebolt, in case none of the available drivers or connectors meet your requirements.
