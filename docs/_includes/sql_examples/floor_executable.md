...
{% include query-window.html sql_file="sql_examples/floor_example_0.sql" %}
...
{% include query-window.html sql_file="sql_examples/floor_example_1.sql" %}
...
{% include query-window.html sql_file="sql_examples/floor_example_2.sql" %}
...
{% include query-window.html sql_file="sql_examples/floor_example_3.sql" %}
