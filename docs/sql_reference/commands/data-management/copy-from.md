...
* Handle errors during data loading for both CSV and Parquet files.
...
| `<column_mapping>`         | (Optional) Available if the target table exists. Specifies mapping between the source and target schema.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `<column_name>`            | Name of a target column in a table. Source columns will be automatically mapped based on name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| `<default_value>`          | A replacement value for `NULL` values, compatible with the target column's data type.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `<source_column_index>`    | Index position of the source column. Index starts at 1, and can be as large as 2^64-1. For example: `COPY INTO t(a $1, b $2) FROM 's3://my_bucket/my_folder/my_file';`.                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `<source_column_name>`     | Name of the source column to be mapped.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `<externalLocations>`      | One or more Amazon S3 paths containing source files. Paths ending with `/` are treated as directories.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `<directoryLocation>`      | Amazon S3 path to a directory.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `CREDENTIALS`              | Amazon S3 credentials for accessing `<externalLocations>`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `PATTERN`                  | A [glob pattern](https://en.wikipedia.org/wiki/Glob_(programming)) or regular expression to match filenames or strings.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `TYPE`                     | The file type for files identified by `PATTERN`. If unspecified, Firebolt auto-detects based on the file’s suffix.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `AUTO_CREATE`              | Whether Firebolt should auto-create a table if missing. Default is `TRUE`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `ALLOW_COLUMN_MISMATCH`    | Set to `FALSE` to enforce all required columns in source files. Missing columns trigger errors.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `ERROR_FILE`               | Amazon S3 location for writing error files.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `ERROR_FILE_CREDENTIALS`    | Amazon S3 credentials for writing error files.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `MAX_ERRORS_PER_FILE`      | Maximum number of rows that can be rejected per file, as an integer or percentage (e.g., `100%`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |

### Parameters for CSV files

| Parameter             | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
|:----------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `HEADER`              | Specify if the file contains a header line with column names. Default is `TRUE`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `DELIMITER`           | Character used to separate fields. Default is a comma (`,`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `NEWLINE`             | Character for row delimiters. Default is `\n`. Custom delimiters are allowed only if the target table exists.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `QUOTE`               | Character used for quoting fields. Default is double quote (`"`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `ESCAPE`              | Character used to escape special characters. Default is the quote character.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `NULL_STRING`         | String representing `NULL` values. Default is an empty string.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `EMPTY_FIELD_AS_NULL` | Whether empty fields should be interpreted as `NULL` values.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `SKIP_BLANK_LINES`    | Whether to ignore blank lines.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `DATE_FORMAT`         | Date format for parsing text into date columns. For supported formats, see [TO_DATE](../../functions-reference/date-and-time/to-date.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `TIMESTAMP_FORMAT`    | Timestamp format for parsing text into timestamp columns. For supported formats, see [TO_TIMESTAMP](../../functions-reference/date-and-time/to-timestamp.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
