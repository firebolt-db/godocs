...
<Note>
If you want to know how this works under the hood, check out our [engineering blog on zero copy data cloning](https://www.firebolt.io/blog/firebolts-zero-copy-clone).
</Note>
