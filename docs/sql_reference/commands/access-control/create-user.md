...
| `<database_name>`                      | (Optional) Defines the default database for the user (for future purposes). |
| `<engine_name>` | (Optional) Defines the default engine for the user (for future purposes). |
