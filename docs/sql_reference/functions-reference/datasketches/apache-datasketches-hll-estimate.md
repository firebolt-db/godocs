...
|:---------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------|
| `<expression>` | An [Apache DataSketches HLL sketches](https://datasketches.apache.org/docs/HLL/HllSketches.html) in a valid format, e.g. the output of the [APACHE_DATASKETCHES_HLL_BUILD](apache-datasketches-hll-build.md) function. | `BYTEA`               |
