...
If you want to count elements based on specific criteria, you can use the [ARRAY_COUNT](../array/array-count.md) function with a `SUM` aggregation as demonstrated below.
