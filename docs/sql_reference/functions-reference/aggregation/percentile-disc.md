...
`PERCENTILE_DISC` is available as a [window function](../window/index.md).
See also [PERCENTILE_CONT](./percentile-cont.md), which calculates an interpolated result, rather than matching any of the specific column values.
