...
| [HLL_COUNT_BUILD](./numeric/hll-count-build.md)                       | Counts the approximate number of unique not NULL values, aggregating the values to HLL++ sketches represented as the [BYTEA data type](../bytea-data-type.md).                                                                                                                                   | Conditional & miscellaneous |
| [HLL_COUNT_ESTIMATE](./numeric/hll-count-estimate.md)                 | Extracts a cardinality estimate of a single HLL++ sketch that was previously built using the aggregate function [`HLL_COUNT_BUILD`](hll-count-build.md).                                                                                                                                                           | Conditional & miscellaneous |
| [HLL_COUNT_MERGE](./numeric/hll-count-merge.md)                       | Merges one or more HLL++ sketches that were previously built using the aggregate function [`HLL_COUNT_BUILD`](hll-count-build.md) into a new sketch.                                                                                                                                                               | Conditional & miscellaneous |
