...
| auto_vacuum                 | BOOLEAN     | Indicates whether Auto-VACCUM is enabled/disabled for the engine. Could also be `NULL` to indicate default behavior of enabled Auto-VACUUM. |
