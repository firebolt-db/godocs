...
To view column information, the user must have `USAGE`  privileges on both the [schema]({% link Overview/Role-Based Access Control/database-permissions/schema-permissions.md %}#schema-level-privileges) and the [database]({% link Overview/Role-Based Access Control/database-permissions/index.md %}#database-level-privileges), as well as any necessary [table-level privileges]({% link Overview/Role-Based Access Control/database-permissions/table-permissions.md %}#table-level-privileges) or ownership of the table.
