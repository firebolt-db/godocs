...
To access information about views, you must have `USAGE` privileges on both the [schema]({% link Overview/Security/Role-Based Access Control/database-permissions/schema-permissions.md %}#schema-level-privileges) and the [database]({% link Overview/Security/Role-Based Access Control/database-permissions/schema-permissions.md %}#schema-level-privileges). You also need ownership of the view or [view-level privileges]({% link Overview/Security/Role-Based Access Control/database-permissions/view-permissions.md %}#view-permissions). 
