...
To view engine information, the user must have ownership of the engine or access to the necessary [engine]({% link Overview/Role-Based Access Control/engine-permissions.md %}#engine-permissions) privileges. 
