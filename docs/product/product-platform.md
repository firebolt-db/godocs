...
## <img src="../assets/images/icon-data_management.png" alt="Icon for data management." width="40" style="display: inline; margin-bottom: 0; margin-top: 0" /> Data management
...
## <img src="../assets/images/icon-processing.png" alt="Icon for query processing." width="40" style="display: inline; margin-bottom: 0; margin-top: 0" /> Query processing
...
## <img src="../assets/images/icon-security.png" alt="Icon for security." width="40" style="display: inline; margin-bottom: 0; margin-top: 0" /> Security
...
## <img src="../assets/images/icon-observability.png" alt="Icon for observability." width="40" style="display: inline; margin-bottom: 0; margin-top: 0" /> Observability
...
## <img src="../assets/images/icon-collaboration.png" alt="Icon for collaboration." width="40" style="display: inline; margin-bottom: 0; margin-top: 0" /> Collaborative workspace
