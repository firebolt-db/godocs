...
| **Engine name**             |Provide the name of the Firebolt engine that will be used to execute queries against the database.                                                                                                                                                                                                                             |
...
1. Select **Save** to store your database configuration.
