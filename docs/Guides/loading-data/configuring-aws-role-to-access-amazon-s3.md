...
3. Select the **Create policy** button in the top right part of the main window.
4. In the **Select a service** pane, enter and select **S3** in the search bar under **Service**.
5. In the **S3** pane, in the search bar under **Actions allowed**, enter and select the checkbox next to **GetObject**.
6. Under **Resources**, select the radio button next to **All**.
7. Select the **Next** button in the bottom right part of the main window.
8. Under **Policy name** enter a name that you can use to identify this policy.
9. Select the **Create policy** button in the bottom right part of the main window.
10. Select **Roles** from the left navigation panel.
11. Select the **Create role** button in the top right part of the main window.
12. In the **Select trusted entity** window, select the radio button next to **Custom trust policy**.
13. A **Custom trust policy** window opens. Leave this window open until you obtain a custom trust policy from Firebolt's **Workspace** as follows:
    ...
    9. Return to the AWS **Select trusted entity** window from step 13.
14. Replace the entire contents of the **Custom trust policy** with the contents of your clipboard from the Firebolt **Workspace**.
15. Select the **Next** button in the bottom right part of the main window.
16. Under **Permissions policies** enter the name of and select the checkbox next to the policy you created in step 8.
17. Select the **Next** botton in the bottom right part of the main window.
18. Under **Role name**, enter a name that you can use to identify it.
19. Select the **Create role** button in the bottom right part of the main window.
20. Under **Role name**, select the name of the role you created in step 18.
21. Copy the value under **ARN**. This value has the following format: `arn:aws:iam::123456789012:role/your_role_name` to use in the Firebolt `CREDENTIALS` clause as the `AWS_ROLE_ARN`, as shown in the following sections.
