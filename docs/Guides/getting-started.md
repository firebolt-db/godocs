...
To learn more about how to set up AWS roles to access your data on S3,  see [Use AWS roles to access S3](loading-data/configuring-aws-role-to-access-amazon-s3.md).
