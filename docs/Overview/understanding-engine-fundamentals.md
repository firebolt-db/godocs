...
![An engine cluster in Firebolt](../assets/images/Engine_Cluster.png){: max-width="80%"}
 **An engine cluster with four nodes of type 'M'** 
 {: style="color: red; font-size: 90%; text-align: center;"}


![A Firebolt engine with two clusters, each cluster containing four nodes of type 'M'](../assets/images/Firebolt_Engine.png){: max-width="80%"}
